...
{             
    ...
    if (RunStatus.Running)
    {
         if(RemCtlflag == 1)
        {
            ...
            SendRemCtlCmd(1, CMD_READ_REG, MODBUS_PARAM_ADD, RegCnt, (BYTE *)&ModBusParam);
            Delay(50);
            SendRemCtlCmd(1, CMD_READ_REG, MODBUS_STATUS_ADD, RegCnt, (BYTE *)&ModBusStatus);
            Delay(50);
            SendRemCtlCmd(1, CMD_READ_REG, MODBUS_INFO_ADD, RegCnt, (BYTE *)&ModBusInfo);
            Delay(50);
            SendRemCtlCmd(1, CMD_READ_REG, MODBUS_REM_CTL, RegCnt, NULL);
            Delay(50);
        }
    }
}

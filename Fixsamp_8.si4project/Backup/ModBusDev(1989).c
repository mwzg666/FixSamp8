...
BYTE ReadAck()
{
    ...
    BYTE *p;
    //printf("Modbus = %d\r\n",sizeof(ModBusParam));
    //printf("DataLen = %d\r\n",ReadAckFrame.DataLen);
    //if(sizeof(MODBUS_PARAM) == ReadAckFrame.DataLen)
    //{   
        //printf("READ==OK");
        //printf("DataLen = %d\r\n",sizeof(ReadAckFrame.Data));
...
//     if(sizeof(MODBUS_STATUS) == ReadAckFrame.DataLen)
//    {   
        //memcpy(&ModBusStatus, &ReadAckFrame.Data, sizeof(MODBUS_STATUS));
    //}

      //if(sizeof(MODBUS_INFO) == ReadAckFrame.DataLen)
    //{   

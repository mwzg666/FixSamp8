...
//    SysParam.SampVol = ModBusParam.SampVol;
    SysParam.Enable = (BYTE)ModBusParam.ChEnable;
    SysParam.RemCtlFlag = (bool)ModBusParam.RemCtlFlag;
//    for(i = 0;i < 8;i++)
//    {
...
//    RunStatus.RunTime =  ModBusStatus.RunTime;                 
    RunStatus.Running = (bool)ModBusStatus.RunStatus;               
...
//    }
    ...
    SysParam.Address = (BYTE)ModBusInfo.Address;

...
void RemPageCtl()
{
   static BYTE StartRem[4] = {0};
   static BYTE RemFlag = 0;
   //#if 0
    switch(PageSwitch)
    {
        case 0:
...
//    {
         if(RemReadflag == 1)
        {
            ...
            Delay(50);
//            SendRemCtlCmd(1, CMD_READ_REG, MODBUS_STATUS_ADD, 2, NULL);
//            Delay(50);
//            SendRemCtlCmd(1, CMD_READ_REG, MODBUS_INFO_ADD, 1, NULL);
//            Delay(50);

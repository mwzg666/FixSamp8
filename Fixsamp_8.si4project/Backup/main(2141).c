...
void SyncModBusDev()
{
    ...
    ModBusParam.ChEnable =   (WORD)SysParam.Enable;
...
BYTE SendRemCtlCmd(BYTE Addr, BYTE Cmd, WORD Reg, WORD Count, BYTE * Data)
{
    ...
    SendLen += 2; 
    printf("HostSendFrame.RegAddr = %x\r\n",HostSendFrame.RegAddr);
    printf("HostSendFrame.Data[0] = %x\r\n",HostSendFrame.Data[0]);
    printf("HostSendFrame.Data[1] = %x\r\n",HostSendFrame.Data[1]);
    printf("HostSendFrame.Data[2] = %x\r\n",HostSendFrame.Data[2]);
    printf("HostSendFrame.Data[3] = %x\r\n",HostSendFrame.Data[3]);
    printf("HostSendFrame.Data[4] = %x\r\n",HostSendFrame.Data[4]);
